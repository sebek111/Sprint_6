...
class HomePage(BasePage):
    ...
    def click_to_question(self, num):
        question_locator = self.format_locator(home_locators.QUESTION_LOCATOR_TEMPLATE, num)
    ...
    def get_answer_text(self, num):
        answer_locator = self.format_locator(home_locators.ANSWER_LOCATOR_TEMPLATE, num)
    ...
    def scroll_to_down(self):
        element = self.find_element_with_wait(home_locators.SCROLL_LOCATOR)
        self.scroll_to_element_center(element)
    ...
    def close_cookie_banner(self):
        try:
            self.click_on_element(home_locators.COOKIE_CLOSE_BUTTON)
        except:
            pass
